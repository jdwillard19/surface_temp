...
#################################################################################################
# (Nov 2020 - Jared) - runs source model on all other source lakes to create meta dataset and save results
...
for cts, source_id in enumerate(all_but_target):
    ...
    print("source lake "+ str(cts) + "/" + str(len(all_but_target))+": "+source_id)
    ...
    #save output path
    save_output_path = "../../results/transfer_learning/target_"+target_id+"/source_"+source_id+"/PGDL_output_noTranNoPre"
    ...
    #load model
    load_path = "../../models/"+source_id+"/basicLSTM_source_model_not_transfer_aware_no_pretrain"
...
with open("../../results/transfer_learning/target_"+target_id+"/PGDL_transfer_results_noTran_noPre",'a') as file:
    print("saving to ../../../results/transfer_learning/target_"+target_id+"/PGDL_transfer_results_noTran_noPre")

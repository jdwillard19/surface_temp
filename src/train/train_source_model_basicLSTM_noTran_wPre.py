...
pretrain_path = "../../models/120018084/LSTM_source_model_16hid_4600ep"
...
for epoch in range(n_eps):
    ...
    if verbose and epoch %10 is 0:
        print("rmse loss=", avg_loss)

    if avg_loss < 1:
        save_path = "../../models/"+lakename+"/basicLSTM_source_model_not_transfer_aware_w_pretrain"

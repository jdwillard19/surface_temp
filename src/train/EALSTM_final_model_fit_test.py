...
split_lakenames = err_per_site[err_per_site['n_obs'] >= 200]['site_id'].values[:]
pdb.set_trace()
...
if not os.path.exists("./ealstm_trn_data_final_fitTest0.npy"):
    ...
    np.save("./ealstm_trn_data_final_fitTest0.npy",trn_data)
else:
    trn_data = torch.from_numpy(np.load("./ealstm_trn_data_final_fitTest0.npy"))
...
save_path = "../../models/EALSTM_"+str(n_hidden)+"hid_"+str(num_layers)+"_final_fitTest0"

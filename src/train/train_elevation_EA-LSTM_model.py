...
np.save("../../data/static/lists/elevation_train_ids.npy",train_lakes)
np.save("../../data/static/lists/elevation_test_ids.npy",test_lakes)

train_lakes = np.load("../../data/static/lists/elevation_train_ids.npy",allow_pickle=True)
lakenames = train_lakes
...
np.save("conus_trn_data_wStaticElevationTest.npy",trn_data)
# np.save("_tst_data_wStatic.npy",tst_data)
# sys.exit()
trn_data = torch.from_numpy(np.load("conus_trn_data_wStaticElevationTest.npy"))

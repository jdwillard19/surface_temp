...
for epoch in range(n_eps):
    ...
    if avg_loss < targ_rmse and epoch > targ_ep:
        break
    if epoch % 100 == 0:
        save_path = "../../models/global_model_"+str(n_hidden)+"hid_"+str(num_layers)+"layer_conus_intermediate"
...
save_path = "../../models/global_model_"+str(n_hidden)+"hid_"+str(num_layers)+"layer_conus"

...
for site_range in site_ranges:
    ...
    trn_path = "./10ent_"+str(site_ct)+"to"+len(site_range)"_ctlstm_allstatic_trn_data.npy"
    trn_date_path = "./10ent_"+str(site_ct)+"to"+len(site_range)"_ctlstm_allstatic_trn_dates.npy"
